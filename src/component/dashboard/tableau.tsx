          ...
          {allCriminal.map((row) => (
            <StyledTableRow key={row.nom}>
              ...
              <StyledTableCell className=' flex flex-col' align="right">
                <Button className=' bg-red-700 w-20 mb-1 py-1 text-white rounded-full' textButton='supprimer' /><br />
                <Button className=' bg-[#4361EE] w-20 py-1 text-white rounded-full' textButton='modifer' />
                </StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
