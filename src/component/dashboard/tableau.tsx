...
export default function Tableau() {
  ...
  return (
    <div className=" relative w-[77%] left-[23.9rem] mt-56">
            ...
            {allCriminal.map((row) => (
              <StyledTableRow key={row.nom}>
                ...
                <StyledTableCell className=" flex flex-col" align="right">
                  <Button
                    className=" bg-red-700 w-20 mb-1 py-1 text-white rounded-full"
                    textButton="Supprimer"
                  />
                  <br />
                  <Button
                    className=" bg-[#4361EE] w-20 py-1 text-white rounded-full"
                    textButton="Modifer"
                    onClick={handleClick}
                  />
      ...
      {showForm && (
        <div className="popup z-50 -mt-[999px] flex flex-col items-center justify-center min-h-screen backdrop-blur-sm bg-white/30 h-[100vh]">
          <form >
            <span>
              <InputField
                type="text"
